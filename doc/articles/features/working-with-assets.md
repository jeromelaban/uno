...
For most other assets, Uno.UI uses processes assets once in your **App Library Project** and automatically use them on all platforms. The rest of this document will cover those particular features.
...
Using the asset is done throuh the `ms-appx:///` scheme. 
