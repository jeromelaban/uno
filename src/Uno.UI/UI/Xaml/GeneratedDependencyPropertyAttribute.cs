...
namespace Uno.UI.Xaml
{
	...
	internal sealed class GeneratedDependencyPropertyAttribute : Attribute
	{
		...
		/// <summary>
		/// Declares that the dependency property should be generated as a field.
		/// </summary>
		public bool GenerateAsField { get; set; } = true;

		/// <summary>
		/// Declares that the dependency property should be declared public, otherwise is internal.
		/// </summary>
