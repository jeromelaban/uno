	...
	export class WindowManager {
		...
		private static buildSplashScreen(): Promise<boolean> {
			return new Promise<boolean>(resolve => {
				...
				let UNO_BOOTSTRAP_APP_BASE = config.environmentVariables["UNO_BOOTSTRAP_APP_BASE"] || "";
				let UNO_BOOTSTRAP_WEBAPP_BASE_PATH = config.environmentVariables["UNO_BOOTSTRAP_WEBAPP_BASE_PATH"] || "";

				let fullImagePath = UNO_BOOTSTRAP_APP_BASE !== ''
