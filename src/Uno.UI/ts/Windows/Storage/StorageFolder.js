...
(function (Windows) {
    var Storage;
    (function (Storage) {
        var StorageFolder = /** @class */ (function () {
            function StorageFolder() {
            }
            /**
             * Determine if IndexDB is available, some browsers and modes disable it.
             * */
            StorageFolder.isIndexDBAvailable = function () {
                try {
             ...
             * */
            StorageFolder.makePersistentAsync = function (paths) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        if (!this._isInitialized) {
                            ...
                            StorageFolder.synchronizeFileSystem(true, function () { return StorageFolder.onStorageInitialized(); });
                            window.addEventListener("beforeunload", function () { return _this.synchronizeFileSystem(false); });
                            setInterval(function () { return _this.synchronizeFileSystem(false); }, 10000);
             ...
             * */
            StorageFolder.setupStorage = function (path) {
            ...
            StorageFolder.onStorageInitialized = function () {
                if (!StorageFolder.dispatchStorageInitializedAsync) {
                    if (globalThis.DotnetExports !== undefined) {
                        StorageFolder.dispatchStorageInitializedAsync = globalThis.DotnetExports.Uno.Windows.Storage.StorageFolder.DispatchStorageInitializedAsync;
                    }
                    else {
             ...
             * */
            StorageFolder.synchronizeFileSystem = function (populate, onSynchronized) {
                if (onSynchronized === void 0) { onSynchronized = null; }
...
//# sourceMappingURL=StorageFolder.js.map