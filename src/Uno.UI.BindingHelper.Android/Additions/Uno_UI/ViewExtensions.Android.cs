...
namespace Uno.UI
{
    partial class UnoViewGroup
	{
		...
		/// </summary>
		internal unsafe static long GetMeasuredDimensions_Fast(View view)
		{
		...
		/// </summary>
		internal unsafe static void TryFastRequestLayout_Fast(View view, bool needsForceLayout)
		{
		...
		/// </summary>
		internal unsafe bool IsLayoutRequested_Fast
		...
		internal unsafe void RequestLayout_Fast()
