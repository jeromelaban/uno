			...
			private void ProcessType(INamedTypeSymbol typeSymbol)
			{
				...
				string GetGeneratedCode(INamedTypeSymbol typeSymbol)
				{
					...
					Action<IIndentedStringBuilder> beforeClassHeaderAction = builder =>
					{
						...
						var registerParamApple = _isHotReloadEnabled ? $"\"{typeSymbol.GetFullMetadataName().Replace(".", "_")}\"" : "";
						...
						var registerParamAndroid = _isHotReloadEnabled ? $"\"{typeSymbol.GetFullMetadataName().Replace(".", "/")}\"" : "";
