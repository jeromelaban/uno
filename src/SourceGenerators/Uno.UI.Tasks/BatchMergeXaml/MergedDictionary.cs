...
namespace Uno.UI.Tasks.BatchMerge
{
	public class MergedDictionary
	{
		...
		private static Dictionary<string, string> standardNameDictionary = new Dictionary<string, string> {
			{ /* UWP don't rename */"using:Microsoft.UI.Xaml.Controls", "controls" },
			{ /* UWP don't rename */"using:Microsoft.UI.Xaml.Controls.Primitives", "primitives" },
			{ /* UWP don't rename */"using:Microsoft.UI.Xaml.Media", "media" },
